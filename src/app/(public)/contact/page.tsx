                       ...
                       <div className="flex flex-col justify-between h-full">
                         ...
                         <div className="mt-6 flex gap-3">
                            {(data.details.socials || []).map((s: any, i: number) => {
                               ...
                               let icon = <span className="material-symbols-outlined text-xs">open_in_new</span>;
                               ...
                               return (
                                 <a key={i} href={s.url} target="_blank" rel="noopener noreferrer" className="w-8 h-8 border border-white/10 flex items-center justify-center text-white/40 hover:text-secondary hover:border-secondary transition-all" title={s.name}>
                                    {icon}
                                 </a>
                               );
                            })}
